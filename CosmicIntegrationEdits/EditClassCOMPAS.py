...
class COMPASData(object):
    ...
    def setCOMPASDCOmask(
        self, types="BWD", withinHubbleTime=True, pessimistic=True, noRLOFafterCEE=False
    ):
        ...
        try:
            ...
            stellar_type_1, stellar_type_2, hubble_flag, dco_seeds = \
                self.get_COMPAS_variables("DoubleCompact_Objects", ["Stellar_Type(1)", "Stellar_Type(2)", "Merges_Hubble_Time", "SEED"])
        ...
        if noRLOFafterCEE or pessimistic:
            ...
            # You are not masking for immediate RLOF post CE or HG donor CE       
                ...
                print("you're are not filtering for pessimistic_mask and rlof_mask")
    ...
    def setCOMPASData(self):
        ...
        # Old data formatting has differently named groups
        except:
            primary_masses, secondary_masses, formation_times, coalescence_times, dco_seeds = \
