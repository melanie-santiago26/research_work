...
"""
This function shows the progress bar when boostrapping. It was taken from Lieke van Son's code: https://github.com/LiekeVanSon/LowMBH_and_StableChannel/blob/master/Code/Fig1_MassDistributions.ipynb
"""
